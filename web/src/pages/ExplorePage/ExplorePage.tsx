      ...
      <section className="body-font  text-white ">
        <div className="  ">
          <div className="mb-20 flex w-full flex-col flex-wrap items-center  text-center">
            <div className=" flex  w-full flex-col flex-wrap items-center   px-8 text-center">
              <p className="mb-8 mt-8 w-full bg-slate-700 leading-relaxed text-white lg:w-1/2">
                Our Ai chat technologies are trained on data provided by your
                business. The more data you provide the more accurate the
                responses will be. We can take all your current website,
                business or database data and use it to train your personalised
                chat AI.
              </p>
              <p className="title-font mb-4 bg-slate-700  bg-slate-700 text-2xl font-medium text-white sm:text-3xl">
              ...
              <p className="w-full bg-slate-700 leading-relaxed text-white lg:w-1/2">
                Click on the tabs above to explore our example chat AI stores.
              </p>

              <p className="mb-8 w-full bg-slate-700 leading-relaxed text-white lg:w-1/2">
                ...
                information you provide and will use it to provide the customer
                or employee with a more personalised experience.
              </p>

              <h1 className="title-font mb-2 bg-slate-700 text-2xl font-medium text-white sm:text-3xl">
              ...
              <h1 className="title-font mb-6 bg-slate-700 bg-slate-700 text-2xl font-medium text-white sm:text-3xl">
